...
const QMetaObject AddNew::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_AddNew.data,
      qt_meta_data_AddNew,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
